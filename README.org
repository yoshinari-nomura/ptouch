...
*** Basic Text Placement (top, bottom, center, auto-scale)
    ...
    + Tape width and font size are the defaults: 12mm (-t 12) and 24px (-s 24).
...
*** Complex Example Using Layers
    #+begin_src bash :results silent
      cat images/buppin-layered-demo.txt| ptouch image -a -l40 -t36 -o images/buppin-layered-demo.png
    #+end_src
    Code:
    [[file:images/buppin-layered-demo.txt]]

    #+ATTR_HTML: :height 256px
    [[file:images/buppin-layered-demo.png]]
